...
class BottomNavBarRouting extends StatefulWidget {
  ...
  @override
  _BottomNavBarRoutingState createState() => _BottomNavBarRoutingState();
}

class _BottomNavBarRoutingState extends State<BottomNavBarRouting> {
  @override
